...
if __name__ == "__main__":
    ...
    try:
        ...
        send_email(params["email_notifications"], "the total finished in: {} minutes".format((time.time() - start_time) / 60), "datomize")
    except Exception as e:
        print(e)
        send_email(params["email_notifications"], "error: {},  finished in: {} minutes".format(str(e), (time.time() - start_time) / 60), "datomize")
